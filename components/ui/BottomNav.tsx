...
export default function BottomNav() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Inicio */}
        <Link href="/" className="flex flex-col items-center gap-1" style={{ color: 'var(--pill-text)' }}>
        ...
        {/* Planes */}
        <Link href="/planes" className="flex flex-col items-center gap-1" style={{ color: 'var(--pill-text)' }}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
          </svg>
          <span className="text-[10px] font-medium">Planes</span>
          {pathname === '/planes' && <span className="w-1 h-1 rounded-full bg-positive" />}
        </Link>

        {/* Ajustes */}
        <Link href="/settings" className="flex flex-col items-center gap-1" style={{ color: 'var(--pill-text)' }}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
          ...
          {pathname === '/settings' && <span className="w-1 h-1 rounded-full bg-positive" />}
        </Link>
